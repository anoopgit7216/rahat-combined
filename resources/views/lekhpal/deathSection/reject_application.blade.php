        ...
        <div class="content">
            <div class="container my-sm-5 my-lg-0">
                <div class="designforform shadow-sm mt-3">
                    <h2><small class="text-muted">Reject Applications</small></h2>
                    <h3 class="mb-4">अस्वीकार आवेदन</h3>
                    <form>
                                ...
                                <div class="card-body border rounded mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        @if ($deadperson->application_status == 'approved')
                                            <span class="badge bg-success text-white me-auto"><i
                                                    class="fas fa-check-circle me-1"></i>Approved</span>
                                        @elseif($deadperson->application_status == 'pending')
                                            <span class="badge bg-warning text-dark me-auto"><i
                                                    class="fas fa-clock me-1"></i>Pending</span>
                                        @else
                                            <span class="badge bg-danger text-white me-auto"><i
                                                    class="fas fa-times-circle me-1"></i>{{ ucfirst($deadperson->application_status) }}</span>
                                        @endif
