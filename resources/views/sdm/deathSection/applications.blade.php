@extends('sdm.deathSection.layouts.death_app')
...
@section('content')
                        ...
                        <div class="card mb-4 custom-form-card">
                            @forelse ($deadpersondetails as $deadperson)
                                ...
                                <div class="card-body border rounded mb-3">
                                    ...
                                    <p class="card-text mb-1">Current Stage: <strong>SDM</strong></p>
                                    ...
                                    <div class="d-flex align-items-center mt-2 justify-content-between flex-wrap">
                                        <div class="d-flex align-items-center flex-wrap">
                                            {{-- Previous Status --}}
                                            @if ($riStatus == 1)
                                                <span class="badge bg-success me-2">Approved by Revenue Inspector</span>
                                            @elseif ($riStatus == 2)
                                                <span class="badge bg-danger me-2">Rejected by Revenue Inspector</span>
                                            @endif

                                            @if ($naibStatus == 1)
                                                <span class="badge bg-success me-2">Approved by Naib Tahsildar</span>
                                            @elseif ($naibStatus == 2)
                                                <span class="badge bg-danger me-2">Rejected by Naib Tahsildar</span>
                                            @endif

                                            @if ($tahsildarStatus == 1)
                                                <span class="badge bg-success me-2">Approved by Tahsildar</span>
                                            @elseif ($tahsildarStatus == 2)
                                                <span class="badge bg-danger me-2">Rejected by Tahsildar</span>
                                            @endif
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-outline-primary mt-2 open-modal"
                                                ...
                                                data-resident="{{ $deadperson->resident }}" data-stage="SDM"
    ...
    <div class="modal fade" id="remarkModal" tabindex="-1" aria-labelledby="remarkModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('smagistrate.update.application.status') }}" method="POST">
                @csrf
