...
namespace App\Http\Controllers\RevenueInspector;
...
class RevenueInspectorController extends Controller
{

    public function index()
    {
        return view('revenue-inspector.ri_dashboard');
    }
    public function ahaitukDashboard()
    {
        return view('revenue-inspector.ahaituk_dashboard');
    }
    public function revanueInspectorDashboard()
    {
        ...
        return view('revenue-inspector.deathSection.death_dashboard', compact('deadpersoncountapproved', 'deadpersoncountdelayed', 'deadpersonscount', 'deadpersoncountpending'));
    }
    ...
    public function allDeathApplications()
    {
        ...
        $deadpersondetails = $query->orderByDesc('id')->get();
        return view('revenue-inspector.deathSection.applications', compact('deadpersondetails', 'roleName'));
    }

    public function updateStatusByRI(Request $request)
    {
        $request->validate([
